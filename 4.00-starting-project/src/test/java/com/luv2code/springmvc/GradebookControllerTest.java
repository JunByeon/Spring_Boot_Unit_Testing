...
public class GradebookControllerTest {
    ...
    @Test
    public void deleteStudentHttpResponse() throws Exception {
    ...
    @Test
    public void createAValidGradeHttpReqeust() throws Exception {
    ...
    public void createAValidGradeHttpRequestStudentDoesNotExistEmptyResponse() throws Exception {
        ...
        mockMvc.perform(post("/grades")
                ...
                .andExpect(status().is4xxClientError())
                .andExpect(jsonPath("$.status", is(404)))
                .andExpect(jsonPath("$.message", is("Student or " +
                        "Grade was not found")));
